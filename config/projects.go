...
// ProjectSecretKey derives the key used for client_secret hashing from EnvJWTSecret.
...
// VerifyProjectSecret compara en tiempo constante vía hmac.HMACEqual sobre bytes decodificados — nunca ==.
